...
// Sole job: keep the service worker alive via a persistent port so Edge
...
// Hold an open port to the SW — prevents Chrome/Edge from killing it after 30s.
...
// Background onCommand handles the same shortcut when browser has focus.
